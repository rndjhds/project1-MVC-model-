...
public class MemberDTO {
	...
	public String getMember_mailid() {
		return member_mailid;
	}
	public void setMember_mailid(String member_mailid) {
		this.member_mailid = member_mailid;
	}
